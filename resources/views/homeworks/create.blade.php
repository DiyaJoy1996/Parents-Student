...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card ">
                <div class="card-header">Add Home Work Information</div>
                    ...
                    <form method="POST" action="{{route('homeworks.store')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" id="courseId" class="form-control " name="courseId"
                                    required autocomplete="courseId" autofocus>
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input id="dueDate" type="date" class="form-control" name="dueDate" required
                                        autocomplete="dueDate" autofocus>
