    ...
    <body>
        ...
        <section id="container" class="">
            ...
            <header class="header dark-bg">
                ...
                <!--logo start-->
                <a href="index.html" class="logo">Soft <span class="lite">7011</span></a>
                <!--logo end-->
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                ...
                                <span class="username">{{session('user')->email}}</span>
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu extended logout">
                                <div class="log-arrow-up"></div>
                                <li class="eborder-top">
                                    <a href="{{ route('students.index') }}"><i class="icon_profile"></i> My Profile</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('users.logout') }}"><i class="icon_key_alt"></i> Log Out</a>
                                </li>
            ...
            <aside>
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sub-menu">
                            <a href="{{ route('parents.chat') }}" class="">
                                <i class="icon_document_alt"></i>
                                <span>Parents Chat</span>
