...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card ">
                <div class="card-header">Edit Feedback Information</div>
                    ...
                    <form method="POST" action="{{route('feedbacks.update',$feedback->id)}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control" value="{{ $feedback->homeworkId }}" id="homeworkId"
                                    class="form-control " name="homeworkId" required autocomplete="homeworkId"
                                    autofocus>
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="feedback" type="text" value="{{ $homework->feedback }}" class="form-control "
                                    name="feedback" required autocomplete="feedback" autofocus>
